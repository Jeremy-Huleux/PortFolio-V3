...
$(".element").typed({
  strings: ["un développeur full-stack", 
            "un amoureux des canidés", 
            "un junior en développement", 
            "un passionné des nouvelles technologies", 
            "un enthousiaste de l’apprentissage du code", 
            "un amateur de jeux vidéo", 
            "un amoureux de la nature", 
            "un passionné de la cuisine", 
            "un fan de séries", 
            "un admirateur de la culture japonaise", 
            "un geek assumé", 
            "un passionné par la culture web", 
            "un explorateur de la culture digitale"],
  typeSpeed: 50,
  starDelay: 200,
  backDelay: 600,
  loop: true,
